...
// IncrWeight returns the incremental weight added by this block according to
// the consensus rules
...
// writeGraph outputs a dot graph of the entire blockchain generated by the simulation
// (as observed by one miner)
...
// simStats computes some statistics about the performance of the simulation
...
// mine is where the main consensus logic is implemented
